...
startBtns.forEach((b, i) => {
    ...
    if (exersSolved[id + i]) {
      ...
      status1.innerHTML = "PLAY"
      onMouseoverSquare = onMouseoverSquare
      draggable = true
      move1Btns[i].innerHTML = ""
      move2Btns[i].innerHTML = ""
      move3Btns[i].innerHTML = ""
      move4Btns[i].innerHTML = ""
    }
...
async function onDrop(source, target, boardID, piece) {
    ...
    if (games[exerToSolve].in_checkmate()) {
        ...
        if (currentPage == 1) {
          ...
          reMakeMove3(exerToSolve, move,OriP2[exerToSolve])
          window.localStorage.setItem("move1P2" + exerToSolve, move1Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move1P2" + exerToSolve + "FEN", move1Fen[exerToSolve])
            window.localStorage.setItem("move2P2"+exerToSolve,move2Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move2P2"+exerToSolve+"FEN", move2Fen[exerToSolve])
            window.localStorage.setItem("move3P2"+exerToSolve,move3Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move3P2"+exerToSolve+"FEN", move3Fen[exerToSolve])
            exersSolved[exerToSolve + 6] = true
        } else if (currentPage == 3) {
          reMakeMove3(exerToSolve, move,OriP1[exerToSolve])
          window.localStorage.setItem("move1P3" + exerToSolve, move1Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move1P3" + exerToSolve + "FEN", move1Fen[exerToSolve])
            window.localStorage.setItem("move2P3"+exerToSolve,move2Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move2P3"+exerToSolve+"FEN", move2Fen[exerToSolve])
            window.localStorage.setItem("move3P3"+exerToSolve,move3Btns[exerToSolve].innerHTML)
            window.localStorage.setItem("move3P3"+exerToSolve+"FEN", move3Fen[exerToSolve])
            exersSolved[exerToSolve + 12] = true
        }
        window.localStorage.setItem("exersSolvedL2", exersSolved)

        move4Btns[exerToSolve].style.visibility = "hidden" 
      ...
      if (exerToSolve <6) {
        if (h_Lock.innerHTML == "Disable Locks") {
      ...
      if(checkIfAllexerSolved()){
        ...
        if (checkIfStartPos[exerToSolve]) {
          if (currentPage == 1) {
            ...
            reMakeMove1(exerToSolve, move, OriP2[exerToSolve])
            move1Btns[exerToSolve].click()
          } else if (currentPage == 3) {
            reMakeMove1(exerToSolve, move, OriP3[exerToSolve])
            move1Btns[exerToSolve].click()
          }
          ...
          if (currentPage == 1) {
              ...
              reMakeMove3(exerToSolve, move, OriP3[exerToSolve])
            }
        ...
        if (checkIfStartPos[exerToSolve] == true) {
          ...
          setTimeout(function () {
            ...
            if (currentPage == 1) {
              reMakeMove2(exerToSolve, move2, OriP1[exerToSolve])
            } else if (currentPage == 2) {
              reMakeMove2(exerToSolve, move2, OriP2[exerToSolve])
            } else if (currentPage == 3) {
              reMakeMove2(exerToSolve, move2, OriP3[exerToSolve])
            }
...
function reMakeMove2(i, move, orientation) {
    let movePlayed
    let oppOrientation// I want opponent Orientation because 2nd move is made by enemy
...
function reMakeMove3(i, move,orientation) {
    let movePlayed
    ...
    move3Btns[i].addEventListener("click", function () {
      boardInit(allBoardsDiv[i].id, false, move3Fen[i], orientation)
      startBtns[i].style.backgroundColor = "white"
      move1Btns[i].style.backgroundColor = "white"
      move2Btns[i].style.backgroundColor = "white"
      move3Btns[i].style.backgroundColor = "grey"
  ...
  function reMakeMove4(i, move) {
    ...
    oppOrientation = ((orientation == "white") ? "black" : "white")
    ...
    move4Btns[i].addEventListener("click", function () {
      boardInit(allBoardsDiv[i].id, false, move4Fen[i], )
      startBtns[i].style.backgroundColor = "white"
      move1Btns[i].style.backgroundColor = "white"
      move2Btns[i].style.backgroundColor = "white"
      move3Btns[i].style.backgroundColor = "white"
